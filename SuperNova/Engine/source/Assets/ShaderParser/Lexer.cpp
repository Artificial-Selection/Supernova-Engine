...
TokenType Lexer::StringToTokenType(const std::string& word)
{
    static const std::unordered_map<std::string, TokenType> stringToTokenType
    {
        ...
        {TokenString::DepthWrite,              TokenType::DepthWrite},
        {TokenString::DepthCompare,            TokenType::DepthCompare},
        {TokenString::BlendOp,                 TokenType::BlendOp},
        ...
        {CompareFunctionString::Never,         TokenType::Value_CompareFunction},
        {CompareFunctionString::Less,          TokenType::Value_CompareFunction},
        {CompareFunctionString::Equal,         TokenType::Value_CompareFunction},
        {CompareFunctionString::LessEqual,     TokenType::Value_CompareFunction},
        {CompareFunctionString::Greater,       TokenType::Value_CompareFunction},
        {CompareFunctionString::NotEqual,      TokenType::Value_CompareFunction},
        {CompareFunctionString::GreaterEqual,  TokenType::Value_CompareFunction},
        {CompareFunctionString::Always,        TokenType::Value_CompareFunction},

        {BlendOpString::Add,                   TokenType::Value_BlendOp},
        {BlendOpString::Subtract,              TokenType::Value_BlendOp},
        {BlendOpString::ReverseSubtract,       TokenType::Value_BlendOp},
        {BlendOpString::Min,                   TokenType::Value_BlendOp},
        {BlendOpString::Max,                   TokenType::Value_BlendOp},

        {BlendFactorString::Zero,              TokenType::Value_BlendFactor},
        {BlendFactorString::One,               TokenType::Value_BlendFactor},
        {BlendFactorString::SrcColor,          TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusSrcColor,  TokenType::Value_BlendFactor},
        {BlendFactorString::DstColor,          TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusDstColor,  TokenType::Value_BlendFactor},
        {BlendFactorString::SrcAlpha,          TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusSrcAlpha,  TokenType::Value_BlendFactor},
        {BlendFactorString::DstAlpha,          TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusDstAlpha,  TokenType::Value_BlendFactor},
        {BlendFactorString::ScrAlphaSaturate,  TokenType::Value_BlendFactor},
        {BlendFactorString::Src1Color,         TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusSrc1Color, TokenType::Value_BlendFactor},
        {BlendFactorString::Src1Alpha,         TokenType::Value_BlendFactor},
        {BlendFactorString::OneMinusSrc1Alpha, TokenType::Value_BlendFactor},
